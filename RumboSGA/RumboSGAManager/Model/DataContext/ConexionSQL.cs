    ...
    public static class ConexionSQL
    {
        ...
        public static bool SQLClienteExec(string sqlCommand, ref string error)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    if (ex.Number == 156)
                    {
                        error = Lenguaje.traduce("Se ha añadido algún campo incorrecto, posiblemente una palabra en un campo que va un número");
                    }
        ...
        public static DataTable getDataTable(string query)
        {
            ...
            using (SqlConnection con = new SqlConnection())
            {
                ...
                {
                    log.Error("La sql que genera el error es:" + query + "  ||StackTrace:" + e.StackTrace);
