...
{
    public partial class PorArticuloLoteRegEntrada : Telerik.WinControls.UI.RadForm
    {
        ...
        public PorArticuloLoteRegEntrada(RadGridView gridArticulos)
        {
            InitializeComponent();
            ...
            this.Text = Lenguaje.traduce("Regularización Entrada por Artículo y Lote");
            this.ShowIcon = false;
        ...
        public void aceptar_Event(object sender, EventArgs e)
        {
            ...
            {
                RegulaEntrada.q = ConfigurarSQL.CargarConsulta(path, "REGULARIZACIONESENTRADA") + " WHERE IDENTRADATIPO = 'ER' AND (E.LOTE = '" + loteTextBox.Text + "' AND E.IDARTICULO = '" + articulosList.SelectedRows[0].Cells[0].Value + "')";
                gridArticulos.DataSource = Utilidades.TraducirDataTableColumnNameDT(ConexionSQL.getDataTable(RegulaEntrada.q)).DefaultView;
                this.Close();
            }            
        }
