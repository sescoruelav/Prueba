...
{
    public partial class PorEstadoOrdCarga : Telerik.WinControls.UI.RadForm
    {
        ...
        public PorEstadoOrdCarga(RadGridView gridPedidos)
        {
            InitializeComponent();
            ...
            this.Text = Lenguaje.traduce("Órdenes de Carga por Estado");
            this.ShowIcon = false;
        ...
        {
            DataTable table = Utilidades.TraducirDataTableColumnNameDT(ConexionSQL.getDataTable(ConfigurarSQL.CargarConsulta(path, "LLENARDICCIONARIOESTADOSORDENCARGA")));
        ...
        {
            OrdenesRecogidaControl.q = ConfigurarSQL.CargarConsulta(path, "ORDENESCARGA") + " WHERE CB.IDCARGAESTADO = '" + estadosList.SelectedItem.Text + "'";
            gridPacking.DataSource = Utilidades.TraducirDataTableColumnNameDT(ConexionSQL.getDataTable(OrdenesRecogidaControl.q)).DefaultView;
            this.Close();
        }
