...
{
    public partial class PorEstadoPedido : Telerik.WinControls.UI.RadForm
    {
        ...
        public PorEstadoPedido(RadGridView gridPedidos)
        {
            InitializeComponent();
            ...
            this.Text = Lenguaje.traduce("Pedidos por Estado");
            this.ShowIcon = false;
        ...
        {
            DataTable table = Utilidades.TraducirDataTableColumnNameDT(ConexionSQL.getDataTable(ConfigurarSQL.CargarConsulta(path, "LLENARDICCIONARIOESTADOSPEDIDOS")));
        ...
        {
            PedidosTan.q = ConfigurarSQL.CargarConsulta(path, "PEDIDOSCLIENTE") + " WHERE PC.IDPEDIDOCLIESTADO='" + estadosList.SelectedItem.Text + "'";
