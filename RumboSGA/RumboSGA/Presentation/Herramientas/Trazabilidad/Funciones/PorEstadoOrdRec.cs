...
{
    public partial class PorEstadoOrdRec : Telerik.WinControls.UI.RadForm
    {
        ...
        public PorEstadoOrdRec(RadGridView gridPedidos)
        {
            InitializeComponent();
            ...
            this.Text = Lenguaje.traduce("Órdenes de Recogida por Estado");
            this.ShowIcon = false;
        ...
        {
            OrdenesRecogidaControl.q = ConfigurarSQL.CargarConsulta(path, "ORDENESRECOGIDA") + " WHERE IDORDENESTADO = '" + estadosList.SelectedItem.Text + "'";
