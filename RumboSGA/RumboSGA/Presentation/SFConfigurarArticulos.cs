...
{
    public partial class SFConfigurarArticulos : SFDetalles
    {

        List<CheckBoxNameValue> lstCheckBoxNameValues;
        public SFConfigurarArticulos(string nombre, List<TableScheme> _lstEsquemasParam, dynamic _valuesParam, modoForm _modoAperturaParam, GridScheme _esquemGridParam = null, Hashtable _diccParamNuevoParam = null)
