...
{
    public partial class MaquinasControl : BaseGridControl
    {
        ...
        private void ObtencionTotalRegistros()
        {
            ...
            CantidadRegistros = Business.GetMaquinasCantidad(ref _lstEsquemaTabla);
        ...
        public override void llenarGrid()
        {
            if (_lstEsquemaTabla.Count != 0)
            {
                ...
                {
                    base.llenarGrid();
                    Business.GetMaquinasCantidad(ref _lstEsquemaTabla);
                    GridView.DataSource = null;
                    GridView.DataSource = Business.GetMaquinasDatosGridView(_lstEsquemaTabla);
        ...
        public override void RefreshData(int pageIndex)
        {
            ...
            ExecuteQueryAsync<List<dynamic>>(Task.Run(() => Business.GetMaquinasDatos(sortExpression, filterExpression, pagInicial, pagFinal, _lstEsquemaTabla)), this.Callback);
            ElegirEstilo();
        }
        ...
        private void gridViewFilterChanged_Event(object sender, EventArgs e)
        {
            ...
            {
                lblCantidad.Text = Lenguaje.traduce(strings.NProductos) + ":" + Business.GetMaquinasRegistrosFiltrados(" WHERE " + GridView.FilterDescriptors.Expression).ToString();
