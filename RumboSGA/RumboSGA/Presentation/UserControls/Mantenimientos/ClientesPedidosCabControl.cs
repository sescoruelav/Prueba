...
{
    public partial class ClientesPedidosCabControl : BaseGridControl
    {
        ...
        public ClientesPedidosCabControl()
        {
            InitializeComponent();
        ...
        private void ObtencionTotalRegistros()
        {
            ...
            CantidadRegistros = Business.GetClientesPedidosCabCantidad(ref _lstEsquemaTabla, ref _esquemGrid);
        ...
        public override void llenarGrid()
        {
            if (_lstEsquemaTabla.Count != 0)
            {
                ...
                {
                    base.llenarGrid();
                    Business.GetClientesPedidosCabCantidad(ref _lstEsquemaTabla, ref _esquemGrid);
                    GridView.DataSource = Business.GetClientesPedidosDatosGridView(_lstEsquemaTabla);
        ...
        public override void RefreshData(int pageIndex)
        {
            ...
            {
                sortExpression += "CLICAB." + item.PropertyName;
            ...
            if (filterExpression != null&&filterExpression!=string.Empty)
            {
                ...
                //numRegistrosFiltrados = Business.GetClientesPedidosCabRegistrosFiltrados(filterExpression);
                lblCantidad.Text = Lenguaje.traduce(strings.NProductos) + ":" + this.GridView.ChildRows.Count;

            }
            else
            {
                //numRegistrosFiltrados = Business.GetClientesPedidosCabRegistrosFiltrados("");
                lblCantidad.Text = Lenguaje.traduce(strings.NProductos) + ":" + this.GridView.ChildRows.Count;
            }
            ...
            //ExecuteQueryAsync<List<dynamic>>(Task.Run(() => Business.GetClientesPedidosCabDatos(sortExpression, filterExpression, pagInicial, pagFinal, _lstEsquemaTabla)), this.Callback);
            ElegirEstilo();
        }
        ...
        private void gridViewFilterChanged_Event(object sender, EventArgs e)
        {
            ...
            {
            lblCantidad.Text = Lenguaje.traduce(strings.NProductos) + ":" +this.GridView.Rows.Count;
        ...
        {
            return Business.AltaClientePedidoCab(_lstEsquemaTabla, selectedRow);
        }

        protected override AckResponse NewDataAndLines(dynamic selectedRow, bool bolCloneLines)
        {
            return Business.AltaClientePedidoCabYLineas(_lstEsquemaTabla, selectedRow, _esquemGrid);
        ...
        {
            return Business.EditarClientePedidoCab(_lstEsquemaTabla, selectedRow);
        }

        //Acción para eliminar un Pedido
        protected override AckResponse DeleteData(dynamic selectedRow)
        {
            return Business.EliminarClientePedidoCab(_lstEsquemaTabla, selectedRow);
        }
