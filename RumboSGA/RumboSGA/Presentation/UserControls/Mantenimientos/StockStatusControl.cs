...
{
    public partial class StockStatusControl : BaseGridControl
    {
        ...
        private void ObtencionTotalRegistros()
        {
            ...
            CantidadRegistros = Business.GetStockStatusCantidad(ref _lstEsquemaTabla);
        ...
        public override void llenarGrid()
        {
            if (_lstEsquemaTabla.Count != 0)
            {
                ...
                {
                    base.llenarGrid();
                    Business.GetStockStatusCantidad(ref _lstEsquemaTabla);
                    GridView.DataSource = Business.GetStockStatusDatosGridView(_lstEsquemaTabla,"");
        ...
        public override void RefreshData(int pageIndex)
        {
            ...
            ExecuteQueryAsync<List<dynamic>>(Task.Run(() => Business.GetStockStatusDatos(sortExpression, filterExpression, pagInicial, pagFinal, _lstEsquemaTabla)), this.Callback);
            ElegirEstilo();
        }
